        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-8 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 border-l-4 border-blue-500 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <a href="{{ route('admin.users.index') }}" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg">
                ...
                <div class="p-8">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p class="text-gray-600">
                                @if(!$orders->isEmpty())
                                    Je hebt {{ $orders->count() }} {{ $orders->count() === 1 ? 'bestelling' : 'bestellingen' }} geplaatst
                                @endif
                            </p>
                        </div>
                        @if(!$orders->isEmpty())
                    ...
                    @if($orders->isEmpty())
                        <div class="text-center py-20 px-4">
                            ...
                            <a href="{{ route('home') }}" class="inline-flex items-center gap-3 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                                    ...
                                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-5 border-b-2 border-gray-200">
                                        <div class="flex flex-wrap justify-between items-center gap-4">
                                            ...
                                            <div class="text-sm text-gray-600 bg-white px-3 py-2 rounded-lg shadow-sm">
                                                <span class="font-medium">Bestelnr:</span> <span class="font-mono font-bold text-gray-900">#{{ str_pad($order->id, 6, '0', STR_PAD_LEFT) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="flex justify-between items-center">
                                                <div class="text-sm text-gray-600">
                                                    <span class="inline-flex items-center gap-2">
                                                        ...
                                                        Totaal {{ $order->items->count() }} {{ $order->items->count() === 1 ? 'product' : 'producten' }}
                                                    </span>
                                                </div>
                                                <div class="text-right">
            ...
            @if(!$orders->isEmpty())
                <div class="mt-8 text-center">
                    <a href="{{ route('home') }}" class="inline-flex items-center gap-2 text-amber-600 hover:text-amber-700 font-semibold text-lg transition-colors duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
