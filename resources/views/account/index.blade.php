...
<body class="bg-slate-100 min-h-screen">
    ...
    {{-- Wrap de hele pagina-inhoud zodat modal en kaart dezelfde Alpine state delen --}}
    <div
        x-data="{
            showConfirm: false,
            showEmailForm: false,
    ...
    >
        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 pb-16">
            ...
            {{-- E‑mail card (zonder de modal erin) --}}
            <div class="card-animate bg-white rounded-2xl shadow-md border border-slate-200 mb-5 overflow-hidden">
                ...
                <div class="px-6 py-6">
                    ...
                    {{-- Knop: verified -> modal, anders direct formulier --}}
                    <button
            ...
            {{-- Password card (ongewijzigd, eigen x-data) --}}
        ...
        {{-- VOLLEDIGE SCHERM-POPUP — buiten de card, bovenop de hele pagina --}}
        <div
            x-show="showConfirm"
