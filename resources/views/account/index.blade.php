          ...
          <div x-show="showPasswordForm"
            ...
            <form method="POST" action="{{ route('password.update') }}" class="mt-4 p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-4">
              ...
              <div>
                ...
                @error('current_password', 'updatePassword') <p class="mt-1.5 text-xs text-red-600 font-medium">{{ $message }}</p> @enderror
              </div>
              ...
              <div>
                ...
                @error('password', 'updatePassword') <p class="mt-1.5 text-xs text-red-600 font-medium">{{ $message }}</p> @enderror
              </div>
