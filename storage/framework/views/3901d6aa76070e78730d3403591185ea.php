        ...
        <div class="px-6 py-6">
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl border border-slate-100 dark:border-slate-600">
            <div>
              ...
              <p class="text-slate-800 dark:text-white font-semibold"><?php echo e($user->email); ?></p>
            </div>
          ...
          <div x-show="showEmailForm"
            ...
            <form method="POST" action="<?php echo e(route('account.email.update')); ?>" class="mt-4 p-4 bg-indigo-50 dark:bg-slate-700 rounded-xl border border-indigo-100 dark:border-slate-600 space-y-4">
              <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                  <p class="mt-1.5 text-xs text-red-600 dark:text-red-400 font-medium"><?php echo e($message); ?></p>
                <?php unset($message);
      ...
      <div x-data="{ showPasswordForm:false, showCurrent:false, showNew:false, showConfirmPw:false }"
        ...
        <div class="px-6 py-6">
          ...
          <div x-show="showPasswordForm"
               ...
               x-transition:enter-start="opacity-0 -translate-y-2"
               x-transition:enter-end="opacity-100 translate-y-0">
            <form method="POST" action="<?php echo e(route('password.update')); ?>" class="mt-4 p-4 bg-slate-50 dark:bg-slate-700 rounded-xl border border-slate-100 dark:border-slate-600 space-y-4">
              <?php echo csrf_field(); ?>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1.5 text-xs text-red-600 dark:text-red-400 font-medium"><?php echo e($message); ?></p> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              </div>
