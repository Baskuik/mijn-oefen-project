...
<body class="bg-slate-100 min-h-screen">
    ...
    <div
        x-data="{
            ...
            showEmailForm: false,
            newEmail: '',
            isVerified: <?php echo e($user->email_verified_at ? 'true' : 'false'); ?>
        ...
        <div class="bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 pt-12 pb-24">
            <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="mt-4 flex items-center justify-center gap-4 text-sm">
                    <a href="<?php echo e(route('orders.index')); ?>" class="inline-flex items-center gap-1.5 text-indigo-300 hover:text-white transition-colors duration-200">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-1.5 text-slate-300 hover:text-white transition-colors duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
