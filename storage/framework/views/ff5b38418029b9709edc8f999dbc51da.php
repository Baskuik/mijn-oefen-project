  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mt-14 pb-16">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orders->isEmpty()): ?>
      <div class="bg-white rounded-2xl shadow-md border border-slate-200 text-center py-20 px-6">
        ...
        <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-slate-800 text-white font-semibold rounded-xl hover:bg-slate-700 transition-colors">
    ...
    <?php else: ?>
                  ...
                  <div class="flex items-center justify-between px-6 py-4 gap-4 hover:bg-slate-50/60 transition-colors">
                    <div class="flex items-center gap-4 min-w-0">
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->product?->image): ?>
                        <img src="<?php echo e(asset('storage/' . $item->product->image)); ?>" alt="<?php echo e($item->product->name); ?>" class="w-14 h-14 rounded-xl object-cover flex-shrink-0 border border-slate-100 shadow-sm">
                      <?php else: ?>
                    ...
                    <div class="text-right flex-shrink-0">
                      <p class="text-base font-bold text-slate-900">€<?php echo e(number_format($item->price * $item->quantity, 2, ',', '.')); ?></p>
                    </div>
                  </div>
      ...
      <div class="mt-8 text-center">
        <a href="<?php echo e(route('home')); ?>" class="text-sm text-slate-400 hover:text-slate-700 transition-colors">← Terug naar de shop</a>
      </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
  </div>
