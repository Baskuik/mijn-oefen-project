                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open"
                                 ...
                                 style="display: none;">
                                <a href="<?php echo e(route('account.index')); ?>" class="block px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">Account</a>
                                <a href="<?php echo e(route('dashboard')); ?>" class="block px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">Mijn bestellingen</a>
