<div>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="mb-8">
      <a href="<?php echo e(route('home')); ?>" wire:navigate class="inline-flex items-center text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div
              ...
              <div class="flex gap-6">
                ...
                <div class="flex-grow">
                  <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-2"><?php echo e($item['name']); ?></h3>
                  <p class="text-xl font-bold text-slate-900 dark:text-white mb-4">€<?php echo e(number_format($item['price'], 2, ',', '.')); ?></p>
          ...
          <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-8 sticky top-8">
            ...
            <div class="space-y-4 mb-6">
              <div class="flex justify-between text-slate-600 dark:text-slate-400">
                <span>Subtotaal</span>
                <span class="font-semibold">€<?php echo e(number_format($total, 2, ',', '.')); ?></span>
              </div>
              <div class="flex justify-between text-slate-600 dark:text-slate-400">
              ...
              <div class="border-t border-slate-200 dark:border-slate-700 pt-4">
                <div class="flex justify-between items-center">
                  ...
                  <span class="text-3xl font-bold text-slate-900 dark:text-white">€<?php echo e(number_format($total, 2, ',', '.')); ?></span>
                </div>
              </div>
            </div>
